...
public class SearchMap extends AppCompatActivity implements OnMapReadyCallback, OnLocationClickListener, PermissionsListener, OnCameraTrackingChangedListener{
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                Toast.makeText(SearchMap.this, "Move map to select location or search", Toast.LENGTH_SHORT).show();


                // When user is still picking a location, we hover a marker above the mapboxMap in the center.
                // This is done by using an image view with the default marker found in the SDK. You can
                // swap out for your own marker image, just make sure it matches up with the dropped marker.
                hoveringMarker = new ImageView(SearchMap.this);
                    ...
                    if (response.body() != null) {
                        ...
                        if (results.size() > 0) {
                            ...
                            mapboxMap.getStyle(new Style.OnStyleLoaded() {
                                ...
                                public void onStyleLoaded(@NonNull Style style) {
                                    if (style.getLayer(DROPPED_MARKER_LAYER_ID) != null) {
                                        Toast.makeText(SearchMap.this," Location result: " + feature.placeName(), Toast.LENGTH_LONG).show();
                                    }
                                }
                            });
                            ...
                            feature = null;
                            Toast.makeText(SearchMap.this,(R.string.no_results), Toast.LENGTH_LONG).show();
                        }
                    }
                }
    ...
    private void initConfirmBtn(){
        confirmLoc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //  Send latitude, longitude and location through intent to addNote
                if(getIntent().getStringExtra("source").equals("AddNote")) {
                    Intent i = new Intent(SearchMap.this, AddNote.class);
                    i.putExtra("latitude", Double.toString(sendLatLng.getLatitude()));
                    i.putExtra("longitude", Double.toString(sendLatLng.getLongitude()));
                    i.putExtra("title", getIntent().getStringExtra("title"));
                    i.putExtra("content", getIntent().getStringExtra("content"));
                    i.putExtra("imageURI",getIntent().getStringExtra("imageUri"));                //Image uri

                    if (feature != null) {
                        i.putExtra("location", feature.placeName());
                    } else {
                        i.putExtra("location", "Custom Location");
                    }
                    startActivity(i);
                    finish();

                    //  Send latitude, longitude and location through intent to editNote
                }else if(getIntent().getStringExtra("source").equals("EditNote")){
                        Intent i = new Intent(SearchMap.this, EditNote.class);
                        i.putExtra("latitude",Double.toString(sendLatLng.getLatitude()));
                        i.putExtra("longitude",Double.toString(sendLatLng.getLongitude()));
                        i.putExtra("title",getIntent().getStringExtra("title"));
                        i.putExtra("content",getIntent().getStringExtra("content"));
                        i.putExtra("noteID",getIntent().getStringExtra("noteID"));
                        i.putExtra("imageURI",getIntent().getStringExtra("imageUri"));                //Image uri
    ...
    private void enableLocationComponent(@NonNull Style loadedMapStyle) {
        ...
        if (PermissionsManager.areLocationPermissionsGranted(this)) {
            ...
            LocationComponentOptions customLocationComponentOptions = LocationComponentOptions.builder(this)
                    ...
                    .foregroundDrawable(R.drawable.ic_person_pin_circle_blue_24dp)
                    .build();
                ...
                public void onClick(View view) {
                    ...
                    if (checkGPS()) {
                        if (!isInTrackingMode) {
                            ...
                            Toast.makeText(SearchMap.this, "Tracking enabled", Toast.LENGTH_SHORT).show();
                            tracker.setImageDrawable(ContextCompat.getDrawable(getApplicationContext(), R.drawable.ic_my_location_white_24dp));
                        } else {

                            isInTrackingMode = false;
                            locationComponent.setCameraMode(CameraMode.NONE);
                            Toast.makeText(SearchMap.this, "Tracking disabled", Toast.LENGTH_SHORT).show();
                            tracker.setImageDrawable(ContextCompat.getDrawable(getApplicationContext(), R.drawable.ic_location_searching_white_24dp));
                        }
                    }
                }
            });
    ...
    public void onLocationComponentClick() {
        if (locationComponent.getLastKnownLocation() != null) {
            Toast.makeText(this, ("Current location : "+ (locationComponent.getLastKnownLocation().getLatitude()) +" :" +
